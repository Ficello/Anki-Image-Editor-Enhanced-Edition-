...
from aqt import mw
from aqt import QDialog, QHBoxLayout, QIcon, QResizeEvent, QTabWidget, QTextBrowser, QWidget, Qt
...
# CHANGE_LOG_DAY = "2025-08-12b"
CHANGE_LOG_DAY = "2025-10-28" #🟢

POKEBALL_PATH = r"popup_icon.png"

THE_ADDON_NAME = "🖼️Image Editor (Fixed by Shigeඞ)" #🟢
...
# mini-pupup
SIZE_MINI_WIDTH = 561
SIZE_MINI_HEIGHT = 384
# Width: 561, Height: 384
...
2025-10-28
[1] Bug fixed
    - Fixed a bug that broke filenames in some languages.
    - Fixed a bug that .avif files couldn't be loaded.
"""
...
CHANGE_LOG_TEXT = """\
[ Change log : {addon} ]
Shigeyuki: Hi painter thanks for using this add-on!ඞ {update_text}
{new_feature}
---
